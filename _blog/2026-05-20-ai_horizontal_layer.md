...
We have followed this direction closely because it matches how we think about scientific infrastructure. In 2023, we argued for practical, evidence-aware use of AI in science [(Lawless, 2023)](https://doi.org/10.1016/j.jaci.2023.06.009). In September 18-19 2025, I was presenting related work on probabilistic genomics at the Computational Biology Symposium in Lausanne, where Michael P. Brenner also presented this work on ERA, although it was unnamed at that time.
...
Lawless, D. Reply to Dages et al: You AIn’t using it right: artificial intelligence progress in allergy. *Journal of Allergy and Clinical Immunology* 153, 355-356 (2023). [https://doi.org/10.1016/j.jaci.2023.06.009](https://doi.org/10.1016/j.jaci.2023.06.009)
