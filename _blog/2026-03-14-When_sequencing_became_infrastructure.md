...
The first human genome took thirteen years and billions of dollars.
Today a genome can be sequenced before lunch.
...
Now a different barrier has taken its place.
The problem is no longer reading DNA. It is turning genomic data into decisions that are accurate, representative, and usable.
...
For years, much of genomics depended on a reference that reflected only a narrow slice of humanity.
That is a scientific problem. It is also a clinical one.
...
This is one of the most important transitions now under way in genomics.
A reference that does not represent the world cannot guide the world.
...
This is why data science now sits at the centre of genomics.
The field increasingly depends on shared computational systems where researchers analyse large datasets where they already sit, rather than moving copies from place to place. That shift is practical, but it is also conceptual. Genomics is now as much about systems as it is about sequence.
...
Rare disease makes the state of the field especially clear.
Many patients still endure a long diagnostic odyssey. Standard approaches have solved many cases, but a large fraction remain unresolved.
...
A field this powerful cannot treat ethics as an afterthought.
Genomics changes what can be known about people, families, ancestry, disease risk, and future health. A system with that reach must also be serious about privacy, fairness, communication, misuse, and trust.
...
The Human Genome Project was a beginning.
The past two decades reduced costs and expanded capacity. The coming decade will be defined by something harder: building the systems that make genomic information trustworthy, interpretable, and actionable for everyone.
...
Genomics is no longer limited by whether we can read DNA.
It is limited by whether we can build the infrastructure worthy of what we have learned.
